...
<section class="profile py-4">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-9 page-caet profile-content-main">
                <section class="cart">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="col ">
                                <div class="table-responsive-lg bg-white border">
                                    <table class="table ">
                                        <tbody>
                                        <tr>
                                            <td class="cart-close">
                                            ...
                                            <td>
                                                <img src="images/product/small/4065870.jpg" alt="">
                                            </td>
                                            <td class="pro-name" >
                                                ست شورت و للباس زیر زنانه حرفه ای جکدار و فنردار اسفنجی
                                            </td>
                                            <td class="price cart-count" >
                                                <span>تعداد</span>
                                                <label class="d-none" for="cart-count-input">Example select</label>
                                                <select class="form-control form-control-lg" id="cart-count-input">
                                                    <option>1</option>
                                                </select>
                                            </td>
                                            <td class="price" >11790 تومان</td>
                                        </tr>
                                        <tr>
                                            <td class="cart-close">
                                                <a href="">
